...
Design documents and ideation for the Grand Pattern polyglot implementation
...
```bash
git clone https://github.com/SuperInstance/grand-pattern-design
cd grand-pattern-design
```
